...
{
    /** @var CanResetPasswordContract|Admin */
    protected CanResetPasswordContract $admin;

    public function create(CanResetPasswordContract $admin): string
    {
        $this->admin = $admin;
    ...
    {
        $config = config('auth.passwords.admins');
