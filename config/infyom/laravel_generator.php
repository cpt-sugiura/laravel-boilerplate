...
return [
    ...
    */
    'path' => [
        ...
        'model'           => app_path(implode(DIRECTORY_SEPARATOR, ['Models', 'Eloquents']).DIRECTORY_SEPARATOR),
        ...
        'schema_files'    => storage_path('model_schemas/'),
    ...
    */
    ...
    |
    */
    'model_extend_class' => BaseEloquent::class,
